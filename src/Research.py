...
# Main process
job_urls = make_url('Python', 'Canada', 1, 5)
...
# job_urls = make_url('Developer', 'Canada', 1, 5)
# job_data = speedup(job_urls)  
# df = create_dataframe_of_job_data(job_data)
...
#         for index, row in df.iterrows():
#             sql = "INSERT INTO dice.job_data (DATE, TIME, company_name, job_title, job_location, company_link) VALUES (%s,%s,%s, %s, %s, %s)"
#             values = (date, time, row['company_name'], row['job_title'], row['job_location'], row['company_link'])
#             cursor.execute(sql, values)
#             logging.info("Job details saved in DB successfully")
...
#         for index, row in df.iterrows():
#             sql = "INSERT INTO dice.job_filtered_data (DATE, TIME, company_name, job_title, job_location) VALUES (%s,%s,%s, %s, %s, %s)"
#             values = (date, time, row['company_name'], row['job_title'], row['job_location'], row['company_link'])
#             cursor.execute(sql, values)
#             logging.info("Job details saved in DB successfully")
